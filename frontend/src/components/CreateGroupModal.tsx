...
export default function CreateGroupModal({ isOpen, onClose, onGroupCreated, initialMembers = [] }: CreateGroupModalProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (selectedMembers.length < 1) {
            // System constraint says "Group cannot exist with fewer than 2 active members".
            // Logic: Creator (1) + 1 member = 2 members. So at least 1 other member is required.
            // "Group cannot exist with fewer than 2 active members."
            // If I add 1 member, total = 2.
            // Constraint: "Members cannot add members. Only owner/admin can add members."
            // Valid.
        }

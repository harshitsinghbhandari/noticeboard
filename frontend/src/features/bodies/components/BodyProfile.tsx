...
import { deleteEvent, updateEvent } from '../../events/api/events';
                                ...
                                {activeTab === 'events' && (
                                    <div className="space-y-6">
                                        <div className="flex justify-between items-center">
                                            ...
                                            {canAdmin && <Button size="sm" onClick={() => {
                                                setEditingEvent(null);
                                                setNewEventTitle('');
                                                setNewEventDesc('');
                                                setNewEventLocation('');
                                        ...
                                        {events.map(event => (
                                            <div key={event.id} className="bg-white/5 rounded-2xl border border-white/10 p-4 hover:border-primary/30 transition-all group relative">
                                                <div onClick={() => navigate(`/events/${event.id}`)} className="flex gap-4 cursor-pointer">
                                                    ...
                                                    <div className="absolute top-4 right-4 flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                                        <button
                                                            onClick={(e) => {
                                                                ...
                                                                setNewEventLocation(event.location_name);
                                                        ...
                                                        <button
                                                            ...
                                                            className="p-1.5 bg-red-900/50 text-red-200 rounded-lg hover:bg-red-900"
                                                            title="Delete Event"
                                                        >
